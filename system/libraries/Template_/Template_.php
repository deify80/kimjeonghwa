...
class Template_
{
	...
	var $compile_dir   = 'libraries/Template_/compile';
	var $compile_ext   = 'php';
	var $skin          = '';
	var $notice        = false;
	...
	var $caching       = true;
	var $cache_dir     = '../libraries/Template_/cache';
	...
	function __construct() {
		...
		$this->compile_dir = APPPATH.'libraries/Template_/compile';
		$this->cache_dir = APPPATH.'libraries/Template_/cache';
	}
